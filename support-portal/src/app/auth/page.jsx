...
export default function AuthPage() {
  return (
    <Suspense fallback={<main className="mx-auto mt-16 max-w-xl panel p-6 text-emerald-200">Loading auth...</main>}>
      <AuthPageInner />
    </Suspense>
  );
}
    ...
    <main className="mx-auto grid min-h-[75vh] max-w-5xl items-center gap-6 md:grid-cols-2">
      <section className="space-y-4">
        ...
        <p className="text-emerald-100/70">
          Production-ready auth with hashed passwords and role-based admin tools.
        </p>
      </section>
